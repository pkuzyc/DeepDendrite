...
try:
    ...
    include_dirs = [nrn_srcdir + '/share/lib/python/neuron/crxd/geometry3d', '.', numpy.get_include()]

    srcdir = nrn_srcdir + '/share/lib/python/neuron/crxd/geometry3d/'

    #    name='neuron/crxd/geometry3d',
    setup(
        ext_modules = [
    ...
    #    package_dir = {'': instdir + '/share/lib/python/neuron/crxd/geometry3d'}
