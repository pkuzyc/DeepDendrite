...
#define initmodel initmodel__NMDA
#define _net_receive _net_receive__NMDA
#define _net_init _net_init__NMDA
#define nrn_state_launcher nrn_state_NMDA_launcher
#define nrn_cur_launcher nrn_cur_NMDA_launcher
#define nrn_jacob_launcher nrn_jacob_NMDA_launcher 
#if NET_RECEIVE_BUFFERING
#define _net_buf_receive _net_buf_receive_NMDA
void _net_buf_receive(NrnThread*);
#endif
 
#define state state_NMDA 
...
#define t _nt->_t
#define dt _nt->_dt
#define n_NMDA _p[0*_STRIDE]
#define gama_NMDA _p[1*_STRIDE]
#define tau_r_NMDA _p[2*_STRIDE]
#define tau_d_NMDA _p[3*_STRIDE]
#define Use _p[4*_STRIDE]
#define e _p[5*_STRIDE]
#define i _p[6*_STRIDE]
#define i_NMDA _p[7*_STRIDE]
#define g_NMDA _p[8*_STRIDE]
#define A_NMDA _p[9*_STRIDE]
#define B_NMDA _p[10*_STRIDE]
#define factor_NMDA _p[11*_STRIDE]
#define mggate _p[12*_STRIDE]
#define DA_NMDA _p[13*_STRIDE]
#define DB_NMDA _p[14*_STRIDE]
...
static void _acc_globals_update() {
 ...
 #pragma acc update device (u0) if(nrn_threads->compute_gpu)
 }
...
#pragma acc declare copyin(A_NMDA0)
 static double B_NMDA0 = 0;
#pragma acc declare copyin(B_NMDA0)
...
#define _slist1 _slist1_NMDA
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_NMDA
int* _dlist1;
...
void _net_buf_receive(NrnThread* _nt) {
  ...
  _nrb->_displ_cnt = 0;
  _nrb->_cnt = 0;
  /*printf("_net_buf_receive__NMDA  %d\n", _nt->_id);*/
