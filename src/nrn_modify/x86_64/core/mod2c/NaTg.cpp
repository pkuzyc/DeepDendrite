...
#define initmodel initmodel__NaTg
#define _net_receive _net_receive__NaTg
#define _net_init _net_init__NaTg
#define nrn_state_launcher nrn_state_NaTg_launcher
#define nrn_cur_launcher nrn_cur_NaTg_launcher
...
#define t _nt->_t
#define dt _nt->_dt
#define gNaTgbar _p[0*_STRIDE]
#define vshifth _p[1*_STRIDE]
#define vshiftm _p[2*_STRIDE]
#define slopeh _p[3*_STRIDE]
#define slopem _p[4*_STRIDE]
#define ina _p[5*_STRIDE]
#define gNaTg _p[6*_STRIDE]
#define m _p[7*_STRIDE]
#define h _p[8*_STRIDE]
#define ena _p[9*_STRIDE]
#define mInf _p[10*_STRIDE]
#define mTau _p[11*_STRIDE]
#define mAlpha _p[12*_STRIDE]
#define mBeta _p[13*_STRIDE]
#define hInf _p[14*_STRIDE]
#define hTau _p[15*_STRIDE]
#define hAlpha _p[16*_STRIDE]
#define hBeta _p[17*_STRIDE]
#define Dm _p[18*_STRIDE]
#define Dh _p[19*_STRIDE]
#define _v_unused _p[20*_STRIDE]
#define _g_unused _p[21*_STRIDE]
...
#define _slist1 _slist1_NaTg
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_NaTg
int* _dlist1;
