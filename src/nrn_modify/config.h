...
#define NEURON_DATA_DIR "/raid/zyc/code_for_dhs_paper/install/share/nrn"

/* host triplet */
#define NRNHOST "x86_64-pc-linux-gnu"
...
/* (Remove from nrnconf.h.in) */
#define NRN_CONFIG_ARGS " '--prefix' '/raid/zyc/code_for_dhs_paper/install' '--without-iv' '--with-paranrn' '--with-nrnpython=/usr/bin/python3'"

/* location of NEURON libraries */
#define NRN_LIBDIR "/raid/zyc/code_for_dhs_paper/install/x86_64/lib"
